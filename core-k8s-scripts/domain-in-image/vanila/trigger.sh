...
sed -i s/sample-domain1/$NS_NAME/g  $K8S_DOMAIN_HOME/$NS_NAME/domain.yaml
sed -i s/sample-domain1/$NS_NAME/g  $K8S_DOMAIN_HOME/$NS_NAME/sample-domain1.properties
...
$DOMAIN_IN_IMAGE_HOME_VANILA/apply_sample_domain.sh $NS_NAME
